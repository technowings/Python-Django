...
class PRegistrationForm(forms.Form):
    PR_email=forms.EmailField(widget=forms.TextInput(attrs={'placeholder': 'Type Your Email'}),label='Email',max_length=50,min_length=8,empty_value=False,required=True)
    PR_firstname=forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Type Your First Name'}),label='Firstname',max_length=50,min_length=8,empty_value=False,required=True)
    PR_lastname=forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Type Your Last Name'}),label='Lastname',max_length=50,min_length=8,empty_value=False,required=True)
